...
### Что менял:
1) Заменил id (str) - на uid
    1) в постгре можно хранить как отдельный тип, который компактнее чем text
   2) индексируется нативно
   3) удобнее генерировать автоматом id
2) добавил автогенерацию id | сделал это поле необязательным для передачи при создании
